json.deliveries do
 json.array! @deliveries do |delivery|
  ...
  json.customer delivery.customer, :id, :name, :student_number, :phone_number, :address_name, :address_lat, :address_lng, :static_pay_qr, :photo, :created_at, :updated_at
  json.worker delivery.worker, :id, :name, :student_number, :phone_number, :address_name, :address_lat, :address_lng, :static_pay_qr, :photo, :created_at, :updated_at
 end
end
